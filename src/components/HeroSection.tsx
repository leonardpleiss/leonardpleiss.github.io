    ...
    <section id="about" className="pt-20 pb-10">
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col-reverse md:flex-row gap-10 items-stretch">
          {/* Left: Bio — 3/4 width */}
          <div className="min-w-0 basis-3/4 flex items-center">
            <FadeIn>
          ...
          {/* Right: Photo — 1/4 width, scales with text, max 10rem */}
          <FadeIn className="shrink-0 self-center md:self-stretch md:basis-1/4 flex items-center justify-center">
            {profile.image ? (
              <img
                src={profile.image}
                alt={profile.name}
